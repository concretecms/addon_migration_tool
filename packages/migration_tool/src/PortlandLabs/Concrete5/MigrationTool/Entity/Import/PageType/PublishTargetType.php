...
/**
 * @Entity
 * @Table(name="MigrationImportPageTypePublishTargetTypes")
 */
class PublishTargetType implements PublishableInterface
{
    /**
    ...
    /**
     * @ManyToOne(targetEntity="PublishTargetTypeObjectCollection")
     **/
