...
use PortlandLabs\Concrete5\MigrationTool\Publisher\Logger\Formatter\Object\AccessEntityTypeFormatter;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="MigrationPublisherLogAccessEntityTypes")
 */
class AccessEntityType extends LoggableObject
{
    ...
    {
        return new AccessEntityTypeFormatter();
    }
}
