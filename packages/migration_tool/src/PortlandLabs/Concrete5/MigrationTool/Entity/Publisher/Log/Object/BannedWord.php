...
use PortlandLabs\Concrete5\MigrationTool\Publisher\Logger\Formatter\Object\BannedWordFormatter;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="MigrationPublisherLogBannedWords")
 */
class BannedWord extends LoggableObject
{
    ...
    {
        return new BannedWordFormatter();
    }
}
