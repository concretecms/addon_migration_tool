...
/**
 * @ORM\Entity
 * @ORM\Table(name="MigrationPublisherLogBlocks")
 */
class Block extends LoggableObject
{
     ...
     * @return mixed
     */
    public function getPublishedBlockID()
    {
        return $this->bID;
    }
     ...
     * @param mixed $bID
     */
    public function setPublishedBlockID($bID)
    {
        $this->bID = $bID;
    }
