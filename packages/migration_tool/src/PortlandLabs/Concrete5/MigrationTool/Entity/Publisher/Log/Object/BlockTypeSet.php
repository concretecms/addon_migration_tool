...
use PortlandLabs\Concrete5\MigrationTool\Publisher\Logger\Formatter\Object\BlockTypeSetFormatter;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="MigrationPublisherLogBlockTypeSets")
 */
class BlockTypeSet extends LoggableObject
{
    ...
    {
        return new BlockTypeSetFormatter();
    }
}
