...
use PortlandLabs\Concrete5\MigrationTool\Publisher\Logger\Formatter\Object\ConversationEditorFormatter;
use PortlandLabs\Concrete5\MigrationTool\Publisher\Logger\Formatter\Object\ThumbnailTypeFormatter;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="MigrationPublisherLogConversationEditors")
 */
class ConversationEditor extends LoggableObject
{
    ...
    {
        return new ConversationEditorFormatter();
    }
}
