...
use PortlandLabs\Concrete5\MigrationTool\Publisher\Logger\Formatter\Object\ConversationRatingTypeFormatter;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="MigrationPublisherLogConversationRatingTypes")
 */
class ConversationRatingType extends LoggableObject
{
    ...
    {
        return new ConversationRatingTypeFormatter();
    }
}
