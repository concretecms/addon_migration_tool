...
use PortlandLabs\Concrete5\MigrationTool\Publisher\Logger\Formatter\Object\PermissionKeyFormatter;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="MigrationPublisherLogPermissionKeys")
 */
class PermissionKey extends LoggableObject
{
    ...
    {
        return new PermissionKeyFormatter();
    }
}
