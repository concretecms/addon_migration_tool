...
use PortlandLabs\Concrete5\MigrationTool\Publisher\Logger\Formatter\Object\SiteFormatter;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="MigrationPublisherLogSites")
 */
class Site extends LoggableObject
{
    /**
