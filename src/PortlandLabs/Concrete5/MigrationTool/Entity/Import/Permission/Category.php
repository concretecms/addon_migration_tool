 ...
 */
class Category implements PublishableInterface, LoggableInterface
{
    /**
    ...
    {
        $object = new \PortlandLabs\Concrete5\MigrationTool\Entity\Publisher\Log\Object\PermissionKeyCategory();
