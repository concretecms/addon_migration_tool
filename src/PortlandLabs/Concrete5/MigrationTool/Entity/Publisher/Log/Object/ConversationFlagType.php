...
use PortlandLabs\Concrete5\MigrationTool\Publisher\Logger\Formatter\Object\ConversationFlagTypeFormatter;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="MigrationPublisherLogConversationFlagTypes")
 */
class ConversationFlagType extends LoggableObject
{
    ...
    {
        return new ConversationFlagTypeFormatter();
    }
}
