...
use PortlandLabs\Concrete5\MigrationTool\Publisher\Logger\Formatter\Object\PackageFormatter;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="MigrationPublisherLogPackages")
 */
class Package extends LoggableObject
{
