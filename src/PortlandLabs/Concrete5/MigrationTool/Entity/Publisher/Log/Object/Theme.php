...
use PortlandLabs\Concrete5\MigrationTool\Publisher\Logger\Formatter\Object\ThemeFormatter;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="MigrationPublisherLogThemes")
 */
class Theme extends LoggableObject
{
