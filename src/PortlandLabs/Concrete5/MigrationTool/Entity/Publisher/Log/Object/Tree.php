...
use PortlandLabs\Concrete5\MigrationTool\Publisher\Logger\Formatter\Object\TreeFormatter;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="MigrationPublisherLogTrees")
 */
class Tree extends LoggableObject
{
