...
/**
 * @ORM\Entity
 * @ORM\Table(name="MigrationPublisherLogWorkflowProgressCategories")
 */
class WorkflowProgressCategory extends LoggableObject
{
    ...
    {
        return new WorkflowProgressCategoryFormatter();
    }
}
