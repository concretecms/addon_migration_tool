...
use PortlandLabs\Concrete5\MigrationTool\Publisher\Logger\Formatter\Object\WorkflowProgressCategoryFormatter;
...
use PortlandLabs\Concrete5\MigrationTool\Publisher\Logger\Formatter\Object\WorkflowTypeFormatter;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="MigrationPublisherLogWorkflowTypes")
 */
class WorkflowType extends LoggableObject
{
    ...
    {
        return new WorkflowTypeFormatter();
    }
}
